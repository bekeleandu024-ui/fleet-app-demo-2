...
INSERT INTO "new_Trip" (
    ...
    0,
    "createdAt",
    CAST("customerMessageAudit" AS TEXT),
    "delayRiskPct",
    0,
    "destLat",
    "destLon",
    "driver",
    "driverId",
    CAST("driverMessageAudit" AS TEXT),
    0,
    "etaBaseline",
    "etaPrediction",
    NULL,
    ...
    "lastSuggestedBy",
    "lastSuggestedDriverId",
    CAST("lastSuggestedPlan" AS TEXT),
    "lastSuggestedRateId",
    "lastSuggestedUnitId",
    "lastSuggestionAt",
    "lastSuggestionReason",
