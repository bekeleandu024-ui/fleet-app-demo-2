  ...
  const rates = await Promise.all([
    prisma.rate.create({
      data: {
        ...
        fuelCPM: new Prisma.Decimal(0.04),
        truckMaintCPM: new Prisma.Decimal(0.02),
        trailerMaintCPM: new Prisma.Decimal(0.01),
    ...
    prisma.rate.create({
      data: {
        ...
        fuelCPM: new Prisma.Decimal(0.05),
        truckMaintCPM: new Prisma.Decimal(0.025),
        trailerMaintCPM: new Prisma.Decimal(0.015),
    ...
    prisma.rate.create({
      data: {
        ...
        fuelCPM: new Prisma.Decimal(0.045),
        truckMaintCPM: new Prisma.Decimal(0.022),
        trailerMaintCPM: new Prisma.Decimal(0.013),
